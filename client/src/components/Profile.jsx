...
const Profile = ({ 
  profileData = { // hardcoded stuff
    displayName: "Limmmao",
    username: "Limmmao",
    avatarUrl: "/api/placeholder/120/120",
    location: "London, UK",
    joinDate: "December 2008",
    following: 67,
    followers: 50,
    totalPosts: 221,
    isVerified: true,
      ...
      <div className="flex justify-between p-4 border-b border-gray-800 flex-col bg-black text-white">
        <div className="flex items-center space-x-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{profileData.totalPosts} posts</p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-4 text-gray-500 text-sm">
              <div className="flex items-center space-x-1">
                ...
                <span>{formatJoinDate(profileData.joinDate)}</span>
              </div>
            </div>
